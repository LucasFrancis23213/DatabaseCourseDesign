...
namespace WebAppTest.Controllers
{
    ...
    [ApiController]
    public class EmptyApiFrameController : ControllerBase
    {
        private Connection conn;
        private OracleConnection OracleConnection;
        private BasicSQLOps SQLOps;
        public EmptyApiFrameController(string Uid = "cjh2251646", string Password = "123456", string DataSource = "localhost:1521/orclpdb")
        {

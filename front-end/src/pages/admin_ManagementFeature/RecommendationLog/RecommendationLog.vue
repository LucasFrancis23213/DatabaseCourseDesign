<template>
    ...
    <div style="display: flex; align-items: center; margin-top:10px; gap:20px; margin-right:500px;">
      ...
      <a-input v-model:value="filters.recommendationType" placeholder="推荐类型" style="flex-grow: 1;">
          <template #prefix>
            <HourglassOutlined />
          </template>
      </a-input>
      <a-date-picker v-model:value="filters.startTime" placeholder="开始时间" style="flex-grow: 1;" />
      <a-date-picker v-model:value="filters.endTime" placeholder="结束时间" style="flex-grow: 1;" />
      <a-input v-model:value="filters.userFeedback" placeholder="用户反馈" style="flex-grow: 1;">
          <template #prefix>
            <HourglassOutlined />
          </template>
      </a-input>

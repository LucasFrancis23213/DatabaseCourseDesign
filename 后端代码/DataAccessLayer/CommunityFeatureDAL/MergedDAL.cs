...
namespace DatabaseProject.DataAccessLayer.CommunityFeatureDAL
{
    ...
    public class MergedDAL:IMergedDAL
    {
        ...
        //插入操作
        public Tuple<bool, string> InsertTable(string TableName, List<string> ColumnName, List<object> Value)
        {
            return basicSQLOps.InsertOperation(TableName, ColumnName, Value); 
        }
        ...
        // 查询操作
        public Tuple<bool, string> QueryTable(string TableName, Dictionary<string, object> Conditions)
        {

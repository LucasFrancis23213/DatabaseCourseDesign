...
namespace DatabaseProject.ServiceLayer.ConmmunityFeature
{
    public class UserPosts
    {
        ...
        public List<User_Posts> GetUserPostsByUserId(int userId)
        {
            try
            {
                var result = UserPostsBusiness.QueryBusiness(new Dictionary<string, object> { { "user_id", userId } });
                return result;
            }
            catch (Exception ex)
            {
        ...
        public List<User_Posts> GetAllPostsSortedByPopularity()
        {
            try
            {
                var allPosts = UserPostsBusiness.QueryBusiness(new Dictionary<string, object> { { "true", "true" } });
                if (allPosts != null)
                {
        ...
        public List<Follow_List> GetFollowListByUserId(int userId)
        {
            try
            {
                var result = FollowListBusiness.QueryBusiness(new Dictionary<string, object> { { "follower_user_id", userId } });
                return result;
            }
            catch (Exception ex)
            {
